    ...
    >
      <div className="rounded border border-white/10 bg-[#050505] p-6 sm:p-8 github-graph-container relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
          <div>
            <h2 className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mb-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-mono text-gray-400 bg-white/5 hover:bg-white/10 hover:text-gray-200 border border-white/10 rounded transition-all w-fit"
          >
        ...
        <div className="overflow-x-auto pb-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          <div className="min-w-[720px]">
            {/* Month labels */}
            <div
              className="flex mb-2 text-[10px] font-mono text-gray-500 uppercase tracking-widest relative h-4"
            ...
            <div className="flex gap-0" style={{ position: "relative" }}>
              {/* Day labels */}
              <div className="flex flex-col justify-between pr-3 text-[10px] font-mono text-gray-500 uppercase tracking-widest flex-shrink-0"
        ...
        <div className="flex items-center justify-end gap-2 mt-4 pt-4 border-t border-white/5">
          ...
          <span className="text-[10px] font-mono text-gray-500 uppercase tracking-widest ml-1">
            More
          </span>
        </div>
